...
export type IMovableCharacter = ICharacter<{ movable: IMovable }> & { moving: IMovable };

export type IAttackingCharacter = ICharacter<{ attacking: IAttacking }> & { fighting: IAttacking };

export type ICollectingCharacter = ICharacter<{ collecting: ICollecting }> & { collecting: ICollecting };
